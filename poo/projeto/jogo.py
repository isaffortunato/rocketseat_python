...
# Personagem: classe mae > tudo oq é comum entre todos os personagens
...
class Jogo:
    ...
    def __init__(self) -> None:
        self.heroi = Heroi("Herói", 100, 5, habilidade="Super Força")
        self.inimigo = Inimigo("Morcego", 80, 5, tipo="Voador")
